"""
train_pino_physics_informed.py
FNO + VTCM 物理信息训练脚本。
"""
import argparse
import os
...
def parse_args(argv=None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="FNO + VTCM Physics-Informed Training")
    # 训练超参
    ...
    p.add_argument("--num_fno_modes",        type=int,   default=128)
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        pw_ep = physics_weight_at_step(global_step, args.warmup_steps,
                                       args.physics_ramp_steps, args.physics_weight)
        print(
            f"[{epoch + 1:4d}/{args.epochs}] train={avg_train:.4e}"
